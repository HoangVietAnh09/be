...
async function dbLoad() {
  try {
    ...
    await  mongoose.connect("mongodb+srv://vietanh092004_db_user:Vietanh123@cluster0.lflo7er.mongodb.net/photo_share?appName=Cluster0")
  ...
  console.log("Deleted all schemaInfo");
